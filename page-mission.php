    ...
    <section style="position:relative;width:100%;padding:20px 40px;box-sizing:border-box;flex:1;">
        ...
        <div style="max-width:1200px;margin:0 auto;position:relative;z-index:3;display:flex;gap:60px;align-items:flex-start;">
            ...
            <div style="flex:1;min-width:0;">
                ...
                <!-- 説明文 -->
                <div style="font-size:0.78rem;color:#374151;font-weight:700;line-height:1.7;margin-bottom:14px;">
                ...
                <div style="margin-bottom:12px;margin-top:-30px;">
                    ...
                    <p style="font-size:0.78rem;color:#1a1a1a;font-weight:700;line-height:1.7;">
                        ...
                        あります。<br>
                        「<span style="color:#e94829;font-weight:900;font-size:1.15rem;">環境</span><span style="color:#003894;font-weight:900;font-size:1.15rem;">＝</span><span style="color:#00a0e9;font-weight:900;font-size:1.15rem;">地球</span><span style="color:#003894;font-weight:900;font-size:1.15rem;">＋</span><span style="color:#00a040;font-weight:900;font-size:1.15rem;">Forest</span><span style="color:#003894;font-weight:900;font-size:1.15rem;">＋</span><span style="color:#003894;font-weight:900;font-size:1.15rem;">水</span><span style="color:#003894;font-weight:900;font-size:1.15rem;">＋</span><span style="color:#f39800;font-weight:900;font-size:1.15rem;">Animal</span><span style="color:#003894;font-weight:900;font-size:1.15rem;">＋</span><span style="color:#541b86;font-weight:900;font-size:1.15rem;">街</span><span style="color:#003894;font-weight:900;font-size:1.15rem;">＋</span><span style="color:#b60081;font-weight:900;font-size:1.15rem;">人</span>」という重要な<br>
                ...
                <div>
                    ...
                    <p style="font-size:0.78rem;color:#374151;font-weight:700;line-height:1.7;">
